...
namespace DocumentFormat.OpenXml.Tests
{
    public partial class TestAssets
    {
        public static class TestFiles
        {
            ...
            {
                public const string Document = "TestFiles.Document.dotx";

                public const string Presentation = "TestFiles.Presentation.potx";
            ...
            public const string Document = "TestFiles.Document.docx";
            ...
            public const string Presentation = "TestFiles.Presentation.pptx";
